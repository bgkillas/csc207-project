...
/**
 * Output data for the Add Comment use case. This class holds the details of a comment that has been
 * added, including its content, author, timestamp, and an optional message for the presenter to
 * display.
 */
