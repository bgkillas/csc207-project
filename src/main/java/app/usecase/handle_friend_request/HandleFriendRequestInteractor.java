...
/**
 * Interactor for handling friend request operations.
 * This class contains the  logic for sending, accepting, and declining friend requests.
 * It validates inputs, updates match-related data, and delegates friend addition to the
 * appropriate interactor. It also communicates outcomes to the presenter.
 */
public class HandleFriendRequestInteractor implements HandleFriendRequestInputBoundary {
    ...
    /**
     * Sends a friend request from the current user to the specified target user.
     * Performs checks for null users, self-requests, and duplicate requests.
     *
     ...
     * Validates existence of the request before proceeding and updates both users' friend lists.
     *
     * @param userSession the current user's session
    ...
    /**
     * Declines a pending friend request from the specified user.
     * Validates existence of the request and removes it from both users' request lists.
     *
     * @param userSession the current user's session
     * @param fromUser    the user who sent the friend request
     */
