...
/**
 * Output boundary interface for friend request use cases.
 * Defines methods for presenting the result of sending, accepting, or declining friend requests
 * to the user interface layer (via presenter).
 */
