...
/**
 * Controller for handling user input related to match filter setup.
 * Receives filter preferences from the UI layer and forwards them
 * to the SetupMatchFilterInputBoundary interactor.
 */
public class SetupMatchFilterController {
    ...
    /**
     * Called when the user submits their match filter preferences.
     * Forwards the preferences to the interactor.
     *
