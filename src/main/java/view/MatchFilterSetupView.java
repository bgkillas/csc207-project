...
/**
 * This class builds the GUI form for setting up a user's match filter preferences
 * It collects user input (min age, max age, preferred gender, and location),
 * and sends it to the controller when "Set Match Filter" button pressed
 */
public class MatchFilterSetupView {
    public static JPanel create(SetupMatchFilterController controller) {
        /**
         * Creates a JPanel that includes input fields and a submit button
         * to set up the match filter
         *
