...
/**
 * Tests that the SetupUserProfileInteractor correctly updates the user profile
 * and calls the presenter with the updated user profile
 */
public class SetupUserProfileInteractorTest {
    ...
    public void testSetupUserProfile() {
        ...
        final SetupUserProfileOutputBoundary presenter = updatedUser -> {
        ...
        final SetupUserProfileInteractor interactor = new SetupUserProfileInteractor(
                presenter, session);
