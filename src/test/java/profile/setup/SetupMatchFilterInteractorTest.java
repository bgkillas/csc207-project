...
/**
 * Tests that the SetupMatchFilterInteractor correctly sets a match filter
 * for the current user and calls the presenter with the updated filter
 */
public class SetupMatchFilterInteractorTest {
    ...
    public void testSetupMatchFilter() {
        ...
        final User testUser = new User(
                "testUser", 22, "Male", "Toronto", "Test bio",
        ...
        final SetupMatchFilterOutputBoundary presenter = filter -> {
        ...
        final SetupMatchFilterInteractor interactor = new SetupMatchFilterInteractor(
                presenter, session);
