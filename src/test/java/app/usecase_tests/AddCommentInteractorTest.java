...
public class AddCommentInteractorTest {
    ...
    public void testEmptyCommentFails() {
        ...
        AddCommentInputBoundary interactor =
                new AddCommentInteractor(new InMemoryPostDataAccessObject(), presenter);
    ...
    public void testAddCommentOutputData() {
        ...
        AddCommentOutputData output =
                new AddCommentOutputData("Nice post", "Alice", now, "Success!");
