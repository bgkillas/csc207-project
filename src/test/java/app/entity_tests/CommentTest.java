...
public class CommentTest {
    ...
    public void testConstructorAndGetters() {
        ...
        User alice = new User("Alice", 20, null, null, null, null, null, null);
    ...
    public void testSetText() {
        User bob = new User("Bob", 20, null, null, null, null, null, null);
    ...
    public void testSetAuthor() {
        User oldAuthor = new User("OldAuthor", 20, null, null, null, null, null, null);
        User newAuthor = new User("NewAuthor", 20, null, null, null, null, null, null);
    ...
    public void testSetDate() {
        User author = new User("Author", 20, null, null, null, null, null, null);
